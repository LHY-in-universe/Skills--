...
impl ProviderDisplay {
    pub fn from_provider_id(provider: &str) -> Self {
        match provider {
            ...
            "kimi" | "kimi-coding" | "moonshot" => Self::Moonshot,
            "qwen" | "alibaba" | "dashscope" => Self::Qwen,
            "xai" | "grok" => Self::XAI,
            ...
            "yi" => Self::Yi,
            "local" | "ollama" | "lmstudio" | "vllm" | "llamacpp" => Self::Local,
            _ => Self::Unknown,
        }
    }
    ...
    pub fn default_api_url(&self) -> &'static str {
        match self {
            ...
            Self::MiniMax => "https://api.minimax.chat/v1/text/chatcompletion_v2",
            ...
            Self::Baichuan => "https://api.baichuan-ai.com/v1/chat/completions",
            Self::Yi => "https://api.lingyiwanwu.com/v1/chat/completions",
